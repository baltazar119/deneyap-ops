...
export function raporKapsami(rol: OrgRole | null, uyeIl: string | null): RaporKapsami {
  const hepsi: RaporBolumu[] = [
    ...
    'gecikmeler', 'yaklasan', 'risk', 'trend', 'yorum', 'ham_liste',
  ]
  ...
  switch (rol) {
    ...
    case 'member':
      return {
        ...
        bolumler: new Set<RaporBolumu>([
          ...
          'kpi', 'il_kirilimi', 'tur_kirilimi', 'yaklasan', 'gecikmeler', 'risk', 'trend', 'yorum', 'ham_liste',
        ]),
        kisiBazliVeri: true,
    ...
    case 'viewer':
      return {
        ...
        bolumler: new Set<RaporBolumu>(['kpi', 'il_kirilimi', 'tur_kirilimi', 'gecikmeler', 'risk', 'trend', 'yorum']),
        kisiBazliVeri: false,
