...
export const SAYFALAR = [
  ...
  },
  {
    ...
    kimGorur: [MERKEZ, YONETICI],
    ozet: 'Mevcut görev ve sprint verisinden otomatik hesaplanan, il bazlı kırılımlı risk göstergesi.',
    bolumler: [
      'Durum özeti: "3 acil, 1 orta öncelikli konu var. En kritik: İzmir." gibi tek cümlelik özet — çıplak bir skor değil',
      '"Hangi ile bakmalıyım?": il kartları, en riskliden sıralı — her kartta 0-100 skor + karşılaştırma çubuğu + "1 görev bloke · 2 açık görev" gibi kısa özet',
      'İl kartına tıklayınca doğrudan o ilin görevleri filtrelenmiş şekilde açılır',
      'Yapılacaklar: her sinyalin altında soyut tespit değil somut aksiyon — "Sorumlularla konuşup yeni bir termin belirleyin veya görevi başka birine devredin" gibi',
      'Sorun yoksa "Her şey yolunda görünüyor" sakin mesajı',
    ],
    eylemler: ['İl kartına tıkla › o ilin görevlerine git', 'Yapılacaklar listesindeki sinyale tıkla › ilgili ekrana git'],
    not: 'PRD’nin "hangi il risk altında" sorusuna doğrudan cevap verir — eskiden tek bir toplu organizasyon skoru vardı, hangi ilin sorunlu olduğu hiç görünmüyordu.',
  },
  {
    yol: '/raporlar',
    baslik: 'Raporlar',
